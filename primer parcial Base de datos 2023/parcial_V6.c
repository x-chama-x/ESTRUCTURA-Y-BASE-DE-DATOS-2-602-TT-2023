        ...
        if (nFactura != 0) {
            ...
            do {
                ...
                if (codArt != 0) {
                    ...
                    // Validar si hay suficiente stock del artículo
                    if (a.sto_art < cantArt) {
                        printf("Error: No hay suficiente stock del artículo.\n");
                        return;
                    }

                    // Actualizar el stock y la facturación del artículo
                    a.sto_art -= cantArt;
                    ...
                    rewind(cl);
                    int flag=0;
                    while (fread(&c, sizeof(c), 1, cl)&&flag==0) {
